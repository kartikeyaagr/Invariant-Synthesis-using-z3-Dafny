    ...
    def tokenize(self) -> List[Token]:
        while self.current_char():
            ...
            if self.current_char() in ['"', "'"]:
                ...
                self.tokens.append(Token(TokenType.LITERAL, value, line, column))
                continue
...
class DafnyParser:
    ...
    def parse_while_loop(self) -> LoopInfo:
        ...
        # Parse loop body
        body_start = self.current_token().line
        ...
        body_end = self.current_token().line
